...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (joinBtn) {
    joinBtn.addEventListener('click', () => {
      ...
      if (username !== "") {
        // 1. Esconde o login imediatamente
        if (loginScreen) loginScreen.style.display = 'none';
        
        // 2. Usa o requestAnimationFrame para dar um respiro ao motor gráfico
        // impedindo que a tela fique branca ou trancada na transição
